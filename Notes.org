...
F:  - 3.546153603568291e-2*exp(-175.99551054765925 + 5.337958951149179*max(50.0, y) - 4.0475188366292984e-2*max(50.0, y)^2)*max(50.0, y)
    - 5.3192304053524354e-2*exp(-43.55555555555557 + 1.5555555555555554*max(50.0, y) - 1.3888888888888885e-2*max(50.0, y)^2)*max(50.0, y)
    - 1.4870025084987265e-6*max(50.0, y);
    - 4.432692004460364e-3*exp(-256.8888888888889 + 7.555555555555555*max(50.0, y) - 5.555555555555555e-2*max(50.0, y)^2)*max(50.0, y)
F:  - 1.4870025084987265e-6
    - 4.432692004460364e-3*exp(-256.8888888888889 + 7.555555555555555*max(50.0, y) - 5.555555555555555e-2*max(50.0, y)^2)
    - 3.546153603568291e-2*exp(-175.99551054765925 + 5.337958951149179*max(50.0, y) - 4.0475188366292984e-2*max(50.0, y)^2)
    - 5.3192304053524354e-2*exp(-43.55555555555557 + 1.5555555555555554*max(50.0, y) - 1.3888888888888885e-2*max(50.0, y)^2)
