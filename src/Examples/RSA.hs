...
-- Boole[68+-1*(sqrt(7)*3) + (-1 * x) ≤ 0] * Boole[-1*(68+sqrt(7)*3) + x ≤ 0] * ((15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2*(-68+sqrt(7)*3)^2 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*(-68+sqrt(7)*3)^2+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2*(-68+sqrt(7)*3+(-68+sqrt(7)*3))*x + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+sqrt(7)*3)^2+(15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*(-68+sqrt(7)*3+(-68+sqrt(7)*3))+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2)*x^2 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+sqrt(7)*3+(-68+sqrt(7)*3))+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*x^3 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*x^4)) / (Integrate[(15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2*(-68+sqrt(7)*3)^2 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*(-68+sqrt(7)*3)^2+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2*(-68+sqrt(7)*3+(-68+sqrt(7)*3))*y + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+sqrt(7)*3)^2+(15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*(-68+sqrt(7)*3+(-68+sqrt(7)*3))+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3))^2)*y^2 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+sqrt(7)*3+(-68+sqrt(7)*3))+15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*(-68+-1*(sqrt(7)*3)+(-68+-1*(sqrt(7)*3)))*y^3 + 15/16*(sqrt(7)*3*(sqrt(7)*3)^2*(sqrt(7)*3)^2)^(-1)*y^4), {y, 68+-1*(sqrt(7)*3), 68+sqrt(7)*3}])
