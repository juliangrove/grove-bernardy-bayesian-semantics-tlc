...
-- >>> :set -XDataKinds
-- >>> evalP (normalForm $ clean $ evalβ $ lower $ App l1 (u 1) ⋆ Lam (η (App (hmorph (App height vlad)) (Var Get))))
-- ∫∫∫∫𝟙(0.0 + (1.0 * u) + (-1.0 * z) ≤ 0) * (0.0 + (1.0 * z) + (-1.0 * x) ≐ 0) * (0.0 + (1.0 * u) + (-1.0 * y) ≐ 0) * (((y)) * ((1.7683882565766154e-2 * exp((-513.7777777777778 + (7.555555555555555 * y) + (5.555555555555555e-2 * u^2.0) + (7.555555555555555 * u))))))
